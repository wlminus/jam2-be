...
public class ShopOrderResource {
    ...
    public ResponseEntity<List<ShopOrder>> getAllShopOrders(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {

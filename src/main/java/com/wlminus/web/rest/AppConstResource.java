...
public class AppConstResource {
    ...
    public ResponseEntity<List<AppConst>> getAllAppConsts(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {

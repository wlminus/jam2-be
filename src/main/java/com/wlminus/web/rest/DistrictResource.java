...
public class DistrictResource {
    ...
    public ResponseEntity<List<District>> getAllDistricts(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
